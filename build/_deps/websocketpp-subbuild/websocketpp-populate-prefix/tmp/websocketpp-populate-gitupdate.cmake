...
execute_process(
  COMMAND "/usr/bin/git" show-ref 0.8.2
  WORKING_DIRECTORY "/home/deepx/Documents/keenon_mic/build/_deps/websocketpp-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/0.8.2")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "0.8.2")
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 0.8.2
  WORKING_DIRECTORY "/home/deepx/Documents/keenon_mic/build/_deps/websocketpp-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/zaphoyd/websocketpp.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/deepx/Documents/keenon_mic/build/_deps/websocketpp-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/deepx/Documents/keenon_mic/build/_deps/websocketpp-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
